...
GPUS=2
CONFIG="local_configs/rs-ssm/Swin/swins_realshift_w20_s10.480x480.vspw2.160k.py"

PORT=$(python -c 'import socket; s=socket.socket(); s.bind(("", 0)); print(s.getsockname()[1]); s.close()')
echo "Using port: $PORT"

log_dir="logs/vspw_ss/ours_new"
...
work_dir="work_dirs/vspw_ss/ours_new/${time}"
...
CHECKPOINT="work_dirs/vspw_ss/ours_new/${time}/iter_160000.pth"

log_dir="logs/test_vspw_ss/ours_new"

mkdir -p $log_dir

log_file="$log_dir/${time}_iter_160000.log"

res_dir="/data/ckpt/zhukai/TV3S/res_dirs/vspw_ss/ours_new"
