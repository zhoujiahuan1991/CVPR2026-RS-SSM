...
work_dir="work_dirs/vspw_b5/ours_new/${time}"
...
CHECKPOINT="work_dirs/vspw_b5/ours_new/${time}/iter_240000.pth"

log_dir="logs/test_vspw_b5/ours_new"

mkdir -p $log_dir

log_file="$log_dir/${time}_iter_240000.log"
