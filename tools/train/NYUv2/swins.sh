...
log_dir="logs/nyuv2_ss/ours_new"
...
work_dir="work_dirs/nyuv2_ss/ours_new/${time}"
...
CHECKPOINT="work_dirs/nyuv2_ss/ours_new/${time}/iter_40000.pth"

log_dir="logs/test_nyuv2_ss/ours_new"
