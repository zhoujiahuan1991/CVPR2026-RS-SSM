...
GPUS=2
CONFIG="local_configs/rs-ssm/B1/rs-ssm_realshift_w20_s10.b1.480x640.nyuv2.40k.py"

PORT=$(python -c 'import socket; s=socket.socket(); s.bind(("", 0)); print(s.getsockname()[1]); s.close()')
echo "Using port: $PORT"

log_dir="logs/nyuv2_b1/ours_new"
...
work_dir="work_dirs/nyuv2_b1/ours_new/${time}"
...
CHECKPOINT="work_dirs/nyuv2_b1/ours_new/${time}/iter_40000.pth"

log_dir="logs/test_nyuv2_b1/ours_new"

mkdir -p $log_dir

log_file="$log_dir/${time}_iter_40000.log"

res_dir="/data/ckpt/zhukai/TV3S/res_dirs/nyuv2_b1/ours_new"
