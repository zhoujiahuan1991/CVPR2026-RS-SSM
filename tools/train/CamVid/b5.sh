...
log_dir="logs/camvid_b5/ours_new"
...
work_dir="work_dirs/camvid_b5/ours_new/${time}"
...
CHECKPOINT="work_dirs/camvid_b5/ours_new/${time}/iter_60000.pth"

log_dir="logs/test_camvid_b5/ours_new"

mkdir -p $log_dir

log_file="$log_dir/${time}_iter_60000.log"
